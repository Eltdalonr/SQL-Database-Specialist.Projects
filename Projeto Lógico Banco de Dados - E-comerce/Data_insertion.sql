...
insert into Clients (Fname, Minit, Lname, CPF, Address) 
	   values('Maria','M','Silva', 12346789, 'rua silva de prata 29, Carangola - Cidade das flores'),
			 ...
			 ('Isabela','M','Cruz', 654789123,'rua everaldo 28, Centro - Cidade das flores');
...
insert into orders (idOrderClient, orderStatus, orderDescription, sendValue,idOrderPayment) values 
                             ...
                             (4,default,'compra via web site',150,2);
                             
-- statusDelivery, idordersDelivery
 insert into delivery (statusDelivery, idordersDelivery) values
							('Processando',1),
                            ('Processando',2),
                            ('Processando',3),
                            ('Em andamento',4);
